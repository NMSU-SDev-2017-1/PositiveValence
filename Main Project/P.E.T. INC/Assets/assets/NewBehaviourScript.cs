...
public class NewBehaviourScript : MonoBehaviour {
    ...
    public void Sell()
    {
        ...
        {
            if (applesStored < apple_ammount || bearsStored < bear_ammount || ballsStored < ball_ammount || mopsStored < mop_ammount || broomsStored < broom_ammount || bucketsStored < bucket_ammount || knivesStored < knife_ammount || pansStored < pan_ammount || bleachesStored < bleach_ammount)
                CurrencyMessage.text = "not enough items in inventory to sell";
            else
            {
                applesStored = applesStored - apple_ammount;
                inventoryApple.text = applesStored.ToString();
                ...
                currency = currency + check;
                currencyText.text = currency.ToString();
                CurrencyMessage.text = "Selected tems were sold";
				PlayerPrefs.SetInt ("Coins", currency);
